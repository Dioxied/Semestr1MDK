namespace practik_5
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            rashodtasklabel1 = new Label();
            rashodtasktextbox = new TextBox();
            rashodtasklabel2 = new Label();
            SuspendLayout();
            // 
            // textno
            // 
            ...
            textno.TabIndex = 0;
            textno.Text = "Задание 2";
            // 
            // comboBox1
            // 
            comboBox1.FormattingEnabled = true;
            comboBox1.Items.AddRange(new object[] { "Создать экземпляр", "Наименьшее расх." });
            ...
            textno3.Size = new Size(115, 35);
            textno3.TabIndex = 4;
            textno3.Text = "Class Car";
            // 
            // button1
            // 
            ...
            inputName.Size = new Size(134, 20);
            inputName.TabIndex = 7;
            inputName.Text = "Название модели";
            // 
            // inputDiametr
            // 
            inputDiametr.AutoSize = true;
            inputDiametr.Location = new Point(28, 250);
            inputDiametr.Name = "inputDiametr";
            inputDiametr.Size = new Size(104, 20);
            inputDiametr.TabIndex = 8;
            inputDiametr.Text = "Изготовитель";
            // 
            // inputWeight
            // 
            ...
            inputWeight.Size = new Size(154, 20);
            inputWeight.TabIndex = 9;
            inputWeight.Text = "Количество лош. сил";
            // 
            // inputWonSun
            // 
            inputWonSun.Location = new Point(28, 311);
            inputWonSun.Name = "inputWonSun";
            inputWonSun.Size = new Size(91, 60);
            inputWonSun.TabIndex = 10;
            inputWonSun.Text = "Расход топлива на 100 км";
            inputWonSun.TextAlign = ContentAlignment.MiddleCenter;
            // 
            // textBox1
            // 
            textBox1.Location = new Point(165, 217);
            ...
            // textBox3
            // 
            textBox3.Location = new Point(184, 281);
            ...
            // textBox4
            // 
            textBox4.Location = new Point(165, 314);
            ...
            // ButCreateObj
            // 
            ButCreateObj.Location = new Point(325, 250);
            ...
            // rashodtasklabel1
            // 
            rashodtasklabel1.AutoSize = true;
            rashodtasklabel1.Location = new Point(442, 217);
            rashodtasklabel1.Name = "rashodtasklabel1";
            rashodtasklabel1.Size = new Size(118, 20);
            rashodtasklabel1.TabIndex = 19;
            rashodtasklabel1.Text = "Введите кол. км";
            // 
            // rashodtasktextbox
            // 
            rashodtasktextbox.Location = new Point(566, 214);
            rashodtasktextbox.Name = "rashodtasktextbox";
            rashodtasktextbox.Size = new Size(125, 27);
            rashodtasktextbox.TabIndex = 20;
            rashodtasktextbox.TextChanged += rashodtasktextbox_TextChanged;
            // 
            // rashodtasklabel2
            // 
            rashodtasklabel2.AutoSize = true;
            rashodtasklabel2.Location = new Point(442, 251);
            rashodtasklabel2.Name = "rashodtasklabel2";
            rashodtasklabel2.Size = new Size(0, 20);
            rashodtasklabel2.TabIndex = 21;
            // 
            // Form1
            // 
            ClientSize = new Size(737, 421);
            Controls.Add(rashodtasklabel2);
            Controls.Add(rashodtasktextbox);
            Controls.Add(rashodtasklabel1);
        ...
        private Label rashodtasklabel1;
        private TextBox rashodtasktextbox;
        private Label rashodtasklabel2;
    }
}
